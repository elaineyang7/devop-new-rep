...
# Installing Packages
apt-get install -y apache2 libapache2-mod-fastcgi apache2-mpm-worker libapache2-mod-php5
...
a2enmod actions fastcgi rewrite headers
